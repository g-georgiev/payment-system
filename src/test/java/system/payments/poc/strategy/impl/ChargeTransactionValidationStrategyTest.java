...
public class ChargeTransactionValidationStrategyTest {
    ...
    public void test_validate_transaction_with_valid_transaction() {
        ...
        ChargeTransactionValidationStrategy strategy = new ChargeTransactionValidationStrategy(referenceTransactionRepository, userCredentialsService);
    ...
    public void test_validate_transaction_with_non_existing_referenceId() {
        ...
        ChargeTransactionValidationStrategy strategy = new ChargeTransactionValidationStrategy(mockRepository, userCredentialsService);
        String result = strategy.validateTransaction(transaction);
